...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* Default theme colors */\n:root {\n  --background-color: #fff;\n  --sidebar-color: #0f3460;\n  --topcontent-bottom-border-color: #eee;\n}\n/* \ncolors \n#16213E\n#0F3460\n#533483\n#E94560\n*/\n\n/* Dark theme colors */\n:root.dark {\n  --background-color: rgb(14, 18, 40);\n}\n\n@media (prefers-color-scheme: dark) {\n  /* defaults to dark theme */\n  :root {\n    --background-color: rgb(14, 18, 40);\n    --logo-colors: rgb(245, 102, 0);\n  }\n  /* Override dark mode with light mode styles if the user decides to swap */\n  :root.light {\n    --background-color: #fff;\n    --sidebar-color: #0f3460;\n    --topcontent-bottom-border-color: #eee;\n  }\n}\n\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n  font-size: 62.5%;\n}\n\nbody {\n  background-color: #545454;\n}\n\n.container {\n  display: grid;\n  grid-template-areas:\n    'sb tc tc'\n    'sb mc ec'\n    'sb mc ec';\n  grid-template-rows: 2fr 6fr;\n  grid-template-columns: 0.5fr 10fr;\n\n  background-color: var(--background-color);\n  max-width: 120rem;\n  height: 100vh;\n}\n\n.sidebar {\n  grid-area: sb;\n  background-color: var(--sidebar-color);\n}\n\n.ion-icon {\n  height: 4rem;\n  width: 4rem;\n  fill: white !important;\n}\n\n.profile-search {\n  grid-area: tc;\n  border-bottom: var(--topcontent-bottom-border-color) solid 1px;\n}\n\n.todo-info {\n  grid-area: mc;\n}\n\n.extra-info {\n  grid-area: ec;\n}\n", "",{"version":3,"sources":["webpack://./src/assets/style.css"],"names":[],"mappings":"AAAA,yBAAyB;AACzB;EACE,wBAAwB;EACxB,wBAAwB;EACxB,sCAAsC;AACxC;AACA;;;;;;CAMC;;AAED,sBAAsB;AACtB;EACE,mCAAmC;AACrC;;AAEA;EACE,2BAA2B;EAC3B;IACE,mCAAmC;IACnC,+BAA+B;EACjC;EACA,0EAA0E;EAC1E;IACE,wBAAwB;IACxB,wBAAwB;IACxB,sCAAsC;EACxC;AACF;;AAEA;EACE,SAAS;EACT,UAAU;EACV,sBAAsB;EACtB,gBAAgB;AAClB;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,aAAa;EACb;;;cAGY;EACZ,2BAA2B;EAC3B,iCAAiC;;EAEjC,yCAAyC;EACzC,iBAAiB;EACjB,aAAa;AACf;;AAEA;EACE,aAAa;EACb,sCAAsC;AACxC;;AAEA;EACE,YAAY;EACZ,WAAW;EACX,sBAAsB;AACxB;;AAEA;EACE,aAAa;EACb,8DAA8D;AAChE;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;AACf","sourcesContent":["/* Default theme colors */\n:root {\n  --background-color: #fff;\n  --sidebar-color: #0f3460;\n  --topcontent-bottom-border-color: #eee;\n}\n/* \ncolors \n#16213E\n#0F3460\n#533483\n#E94560\n*/\n\n/* Dark theme colors */\n:root.dark {\n  --background-color: rgb(14, 18, 40);\n}\n\n@media (prefers-color-scheme: dark) {\n  /* defaults to dark theme */\n  :root {\n    --background-color: rgb(14, 18, 40);\n    --logo-colors: rgb(245, 102, 0);\n  }\n  /* Override dark mode with light mode styles if the user decides to swap */\n  :root.light {\n    --background-color: #fff;\n    --sidebar-color: #0f3460;\n    --topcontent-bottom-border-color: #eee;\n  }\n}\n\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n  font-size: 62.5%;\n}\n\nbody {\n  background-color: #545454;\n}\n\n.container {\n  display: grid;\n  grid-template-areas:\n    'sb tc tc'\n    'sb mc ec'\n    'sb mc ec';\n  grid-template-rows: 2fr 6fr;\n  grid-template-columns: 0.5fr 10fr;\n\n  background-color: var(--background-color);\n  max-width: 120rem;\n  height: 100vh;\n}\n\n.sidebar {\n  grid-area: sb;\n  background-color: var(--sidebar-color);\n}\n\n.ion-icon {\n  height: 4rem;\n  width: 4rem;\n  fill: white !important;\n}\n\n.profile-search {\n  grid-area: tc;\n  border-bottom: var(--topcontent-bottom-border-color) solid 1px;\n}\n\n.todo-info {\n  grid-area: mc;\n}\n\n.extra-info {\n  grid-area: ec;\n}\n"],"sourceRoot":""}]);
// Exports
...
const displayUI = new _display_js__WEBPACK_IMPORTED_MODULE_1__.DisplayUI();
displayUI.addHome();
